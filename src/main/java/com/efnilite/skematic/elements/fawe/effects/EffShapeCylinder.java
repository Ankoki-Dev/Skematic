...
public class EffShapeCylinder extends Effect {
    ...
    protected void execute(Event e) {
        ...
        session.makeCylinder(FaweUtil.toVector(location), FaweUtil.parsePattern(blocks), Math.round((long) radius), Math.round((long) height), filled);
        session.flushQueue();
    }
