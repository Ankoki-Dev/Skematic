...
public class ExprLastCuboidRegion extends SimpleExpression<CuboidRegion> {
    ...
    static {
        Skript.registerExpression(ExprLastCuboidRegion.class, CuboidRegion.class, ExpressionType.PROPERTY,
                "[the] last[ly] created fawe [(cuboid|we|wordedit)][ ]region");
    }
