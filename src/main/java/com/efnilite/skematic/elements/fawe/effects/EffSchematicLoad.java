...
public class EffSchematicLoad extends AsyncEffect {
    ...
    static {
        Skript.registerEffect(EffSchematicLoad.class, "load fawe s(k|ch)em[atic] %strings% [as %-strings%] [[and] (store[d]|save) ([[the] s(k|ch)em[atic]]|it) (in|to) [variable] %-objects%]");
    }
    ...
    protected void execute(Event e) {
        ...
        FaweSchematic schem = new FaweSchematic(new File(schematic));
