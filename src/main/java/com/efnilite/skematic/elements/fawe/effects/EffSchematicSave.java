...
public class EffSchematicSave extends Effect {
    ...
    static {
        Skript.registerEffect(EffSchematicSave.class, "save [[the] s(ch|k)ematic] fawe %fawe cuboidregions% to [[the] file] %string% [with %-fawe schematicformat% format]");
    }
    ...
    protected void execute(Event e) {
        ...
        new FaweSchematic(cuboid).save(new File(schematic), format);
    }
