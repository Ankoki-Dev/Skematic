...
public class EffClearContainer extends Effect {
    ...
    static {
        Skript.registerEffect(EffClearContainer.class, "(clear|delete) [the] fawe content[s] of [the] [container] at %location%");
    }
    ...
    protected void execute(Event e) {
        ...
        session.clearContainerBlockContents(FaweUtil.toVector(location));
        session.flushQueue();
    }
