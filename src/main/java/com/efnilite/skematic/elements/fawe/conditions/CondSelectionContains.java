package com.efnilite.skematic.elements.fawe.conditions;
...
public class CondSelectionContains extends Condition {
    ...
    static {
        Skript.registerCondition(CondSelectionContains.class, "%fawe cuboidregions% contains %location%");
    }
