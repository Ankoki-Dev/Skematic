...
public class EffReplaceBlocks extends Effect {
    ...
    static {
        Skript.registerEffect(EffReplaceBlocks.class, "replace [all ]fawe %itemtypes% [block[s]] with %itemtypes% [block[s]] in %fawe cuboidregions%");
    }
    ...
    protected void execute(Event e) {
        ...
        new BlockArrayClipboard(cuboid).replaceBlocks(cuboid, set, FaweUtil.parsePattern(replacement));
    }
