...
@Name("Fawe - Shape - Hollow cylinder")
...
public class EffShapeHollowCylinder extends Effect {
    ...
    protected void execute(Event e) {
        ...
        session.makeHollowCylinder(FaweUtil.toVector(location), FaweUtil.parsePattern(blocks), (Double) x, (Double) z, Math.round((long) height), (Double) thickness);
        session.flushQueue();
    }
