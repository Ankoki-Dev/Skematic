...
public class EffAsyncWorldCreate extends Effect {
    ...
    static {
        Skript.registerEffect(EffAsyncWorldCreate.class, "(create|load) [the] async[hronous] [world] [(called|named)] %strings% [(1¦using [world[s]] %-world%)]",
                "(load|create) world[s] [(called|named)] %strings% async[hronously] [(1¦using [world[s]] %-world%)]");
    }
