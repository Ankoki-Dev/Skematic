...
@Name("Fawe - Selection dimensions")
...
public class ExprCuboidRegionDimensions extends SimpleExpression<Number> {
    ...
    static {
        Skript.registerExpression(ExprCuboidRegionDimensions.class, Number.class, ExpressionType.PROPERTY,
                "[the] fawe (cuboid|we|worldedit)[ ]region (1¦length|2¦height|3¦width) of %fawe cuboidregions%",
                "[the] %fawe cuboidregions%'s fawe (cuboid|we|worldedit)[ ]region (1¦length|2¦height|3¦width)");
    }
